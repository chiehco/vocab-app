...
export function reviewedExample(item: {originalExample?: {provenance:string;notImportedFromMdOrMaster:boolean;review:string;sentenceEn:string;sentenceZh:string}}) {
  ...
  return e && ['authored_in_this_task','translated_from_user_chinese'].includes(e.provenance) && e.notImportedFromMdOrMaster && ['content_reviewed_20260912_v2','meaning_grammar_translation_checked'].includes(e.review) ? e : undefined;
}
